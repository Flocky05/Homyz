...
const PeopleSays = () => {
    return (
        <div>
                ...
                <div className="grid grid-cols-3 m-4 overflow-hidden p-4">
                    <div className="hover:bg-gradient-to-r from-gray-600 to to-black text-white m-8 p-4  w-full rounded-lg">
                    ...
                    <div className="hover:bg-gradient-to-r from-gray-600 to to-black text-white m-8 p-4 rounded-lg w-full">
                        <h1 className="text-4xl font-bold text-blue-500">``</h1>
                        <p>Money is only a tool. It will take you wherever you wish, but it will not replace you as the driver.</p>
                        <div className="flex gap-4 justify-items-center p-4">
